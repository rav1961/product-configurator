...
//        Enumerable::class => Spatie\LaravelData\Casts\EnumerableCast::class,
    ...
    /*
     * When using the `Makefile:data` command, the package will use these settings to generate
     * the data classes. You can override these settings by passing options to the command.
     */
    'commands' => [

        /*
         * Provides default configuration for the `Makefile:data` command. These settings can be overridden with options
         * passed directly to the `Makefile:data` command for generating single Data classes, or if not set they will
         * automatically fall back to these defaults. See `php artisan Makefile:data --help` for more information
         */
        'Makefile' => [
             ...
             * app/Data/ folder. Data classes can live anywhere, but this is where `Makefile:data` will put them.
             */
            'namespace' => 'Data',

            /*
             * This suffix will be appended to all data classes generated by Makefile:data, so that they are less likely
